...
public class KafkaProducerTest {
    ...
    public static void main(String[] args) {
        ...
        // 添加分区器
        /*connectInfo.put("partitioner.class", "wr1ttenyu.f1nal.study.test.kafka.MyPartitioner");*/

        // 添加拦截器
       /* List<String> interceptors = Arrays.asList("wr1ttenyu.f1nal.study.test.kafka.TimeInterceptor");
